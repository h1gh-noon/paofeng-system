package com.paofeng.job.controller;

import com.paofeng.common.core.constant.Constants;
import com.paofeng.common.core.exception.job.TaskException;
...
import com.paofeng.job.domain.SysJob;
import com.paofeng.job.service.ISysJobService;
import com.paofeng.job.util.CronUtils;
import com.paofeng.job.util.ScheduleUtils;
...
public class SysJobController extends BaseController {
    ...
    public AjaxResult add(@RequestBody SysJob job) throws SchedulerException, TaskException {
        ...
        } else if (StringUtils.containsAnyIgnoreCase(job.getInvokeTarget(), new String[]{Constants.LOOKUP_LDAP,
                Constants.LOOKUP_LDAPS})) {
            return error("新增任务'" + job.getJobName() + "'失败，目标字符串不允许'ldap(s)'调用");
        } else if (StringUtils.containsAnyIgnoreCase(job.getInvokeTarget(), new String[]{Constants.HTTP,
                Constants.HTTPS})) {
